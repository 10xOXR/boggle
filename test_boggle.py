...
class TestBoggle(unittest.TestCase):
    ...
    def test_grid_size_is_width_times_height(self):
        # Test is to ensure that the total size of grid is equal to width * height
        grid = boggle.make_grid(2, 3)
        self.assertEqual(len(grid), 6)

    def test_grid_coordinates(self):
        # Test to ensure that all of the coordinates in the grid can be accessed
    ...
    def test_neighbours_of_a_position(self):
        # Ensure that a position has 8 neightbours
        coords = (1, 2)
    ...
    def test_all_grid_neighbours(self):
        ...
        for pos in grid:
            others = list(grid) # Creates a new liat from the dictionary's keys
            others.remove(pos)
    ...
    def test_search_grid_for_words(self):
        ...
        threeLetterWord = 'ABC'
        nothThereWord = 'EEE'
        full_words = [twoLetterWord, threeLetterWord, nothThereWord]
        stems = ['A', 'AB', 'E', 'EE']
        ...
        self.assertTrue(nothThereWord not in foundWords)

    def test_load_dictionary(self):
        # Test that the 'get_dictionary' function returns a dictionary with a length greater than zero
